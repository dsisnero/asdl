/* File Automatically generated by python_asdl_c.rb */
...
/* 
Generated from ASDL::PyTypesDeclareVisitor
*/
...
static PyObject *Add_singleton, *Sub_singleton, *Mult_singleton, *Div_singleton, 
*Mod_singleton, *Pow_singleton, *LShift_singleton, *RShift_singleton, 
*BitOr_singleton, *BitXor_singleton, *BitAnd_singleton, *FloorDiv_singleton;
...
/* 
Generated from ASDL::PyTypesVisitor
*/
...
static int init_types(void)
{
    ...
    if (!add_attributes(excepthandler_type, excepthandler_attributes, 2)) return 
        0;
...
/* 
Generated from ASDL::Obj2ModPrototypeVisitor
*/
...
/* 
Generated from ASDL::FunctionVisitor
*/
...
FunctionDef(identifier name, arguments_ty args, asdl_seq * body, asdl_seq * 
            decorator_list, expr_ty returns, int lineno, int col_offset, PyArena 
            *arena)
{
    stmt_ty p;
    if (!name) {
...
stmt_ty
If(expr_ty test, asdl_seq * body, asdl_seq * orelse, int lineno, int col_offset, 
   PyArena *arena)
{
    stmt_ty p;
    if (!test) {
...
expr_ty
ListComp(expr_ty elt, asdl_seq * generators, int lineno, int col_offset, PyArena 
         *arena)
{
    expr_ty p;
    if (!elt) {
...
/* 
Generated from ASDL::ObjVisitor
*/
...
/* 
Generated from ASDL::Obj2ModVisitor
*/

int
obj2astmod(PyObject* obj, mod_ty* out, PyArena* arena)
{
    int isinstance;
...
int
obj2aststmt(PyObject* obj, stmt_ty* out, PyArena* arena)
{
    int isinstance;
...
int
obj2astexpr(PyObject* obj, expr_ty* out, PyArena* arena)
{
    int isinstance;
...
int
obj2astexpr_context(PyObject* obj, expr_context_ty* out, PyArena* arena)
{
    int isinstance;
...
int
obj2astslice(PyObject* obj, slice_ty* out, PyArena* arena)
{
    int isinstance;
...
int
obj2astboolop(PyObject* obj, boolop_ty* out, PyArena* arena)
{
    int isinstance;
...
int
obj2astoperator(PyObject* obj, operator_ty* out, PyArena* arena)
{
    int isinstance;
...
int
obj2astunaryop(PyObject* obj, unaryop_ty* out, PyArena* arena)
{
    int isinstance;
...
int
obj2astcmpop(PyObject* obj, cmpop_ty* out, PyArena* arena)
{
    int isinstance;
...
int
obj2astexcepthandler(PyObject* obj, excepthandler_ty* out, PyArena* arena)
{
    int isinstance;
...
/* 
Generated from ASDL::ASTModuleVisitor
*/
...
PyInit__ast(void)
{
    ...
    if (PyDict_SetItemString(d, "Module", (PyObject*)Module_type) < 0) return 
        NULL;
    if (PyDict_SetItemString(d, "Interactive", (PyObject*)Interactive_type) < 0) 
        return NULL;
    ...
    if (PyDict_SetItemString(d, "FunctionDef", (PyObject*)FunctionDef_type) < 0) 
        return NULL;
...
/* 
Generated from ASDL::PartingShots
*/
